 ...
 !(function() {
  ...
  angular.module('TwitterServices', [ ], function($provide) {
    ...
    $provide.factory('$twitter', function($http, $log) {
      ...
      // Prepare cross-domain JSONP call to Twitter Service v1.0
      var url1_0 = 'http://search.twitter.com/search.json'             +
                '?&rpp=100&include_entities=true&result_type=mixed' +
                '&callback=JSON_CALLBACK';

      // Support for Twitter Service v1.1
      var url = 'https://api.twitter.com/1.1/search/tweets.json'             +
                '?&count=100&include_entities=true&result_type=mixed' +
                '&callback=JSON_CALLBACK';
